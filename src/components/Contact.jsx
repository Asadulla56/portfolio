      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-6xl mx-auto relative">
          <div className="relative grid grid-cols-1 lg:grid-cols-5 gap-8 lg:gap-0">
            <div className="lg:col-span-2 bg-gradient-to-br from-blue-400 to-purple-400 rounded-xl shadow-lg p-8 md:p-10 text-white z-0">
            ...
            <div className="lg:col-span-3 bg-white rounded-xl shadow-2xl p-8 md:p-10 z-10 lg:-ml-12">
              {!isSubmitted ? (
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full px-4 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full flex items-center justify-center hover:opacity-90 transition-all duration-300 text-lg font-medium"
                  >
                ...
                <div className="flex flex-col items-center justify-center text-center min-h-[400px]">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-full hover:opacity-90 transition-all duration-300"
                  >
